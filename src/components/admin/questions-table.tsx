...
import { Search, BookOpen, Trash2, ChevronDown, Loader2, X, Upload, CheckCircle2, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
            ...
            <div className="space-y-4">
              <label className={`flex flex-col items-center justify-center border-2 border-dashed rounded-xl p-8 cursor-pointer transition-colors ${importFile ? 'border-blue-400 bg-blue-50' : 'border-gray-300 hover:border-blue-300 hover:bg-gray-50'}`}>
                ...
                {importFile ? (
                  ...
                  <>
                    <p className="text-sm font-medium text-gray-600">Click để chọn file</p>
              ...
              <p className="text-xs text-muted-foreground text-center">
                Chưa có template?{' '}
                <a href="https://05-edu-future-app.vercel.app" className="text-blue-600 underline" target="_blank">
      ...
      <div className="flex gap-3 flex-wrap">
        ...
        <Button onClick={() => setImportOpen(true)} className="gap-2 bg-green-600 hover:bg-green-700">
